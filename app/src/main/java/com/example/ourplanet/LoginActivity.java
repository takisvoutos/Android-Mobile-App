...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleSignInClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    {
                        Toast.makeText(LoginActivity.this, "Connection with google sign in failed.", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode == RC_SIGN_IN)
        {
            ...
            loadingBar.setMessage("Please wait, while we are allowing you to login with your Google Account.");
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        else
                        {
                            ...
                            Toast.makeText(LoginActivity.this, "Sign in failed : " + message, Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                        }
                    }
                });
